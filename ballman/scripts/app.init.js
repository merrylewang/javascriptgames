...
APP.player.Init = function () {
    ...
    APP.player.up_images[0].src = "img/player/up/0.png";
    ...
    APP.player.right_images[1].src = "img/player/right/1.png";
    ...
    APP.player.down_images[0].src = "img/player/down/0.png";
    ...
    APP.player.left_images[1].src = "img/player/left/1.png";
